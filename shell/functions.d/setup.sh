...
install-common-tools() {
  declare -a DefaultPackages=("jq" "python" "go" "hashicorp/tap/terraform" "git" "fzf" "fd" "tmux" "neovim" "zsh" "ripgrep" "bat" "eza" "homebrew/cask-fonts" "iterm2" "htop" "kubectl" "nvm" "npm" "lazygit" "zoxide")
